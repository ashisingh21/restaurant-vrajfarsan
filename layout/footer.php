     ...
     <div class="container">
         ...
         <div class="row">
             <div class="col-md-12 text-center">
                 <!-- .social-links start -->
                 <ul class="social-links" style="display:block; margin:auto;">
                     <li><a target="_blank" href="https://www.instagram.com/vrajfarsan.ca/"><i
                                 class="fa fa-instagram"></i></a>
                     </li>
                     <!-- <li><a href="#"><i class="fa fa-twitter"></i></a></li> -->
                     <li><a target="_blank" href="https://www.facebook.com/people/Vraj-Farsan/61551522506386/"><i
                                 class="fa fa-facebook"></i></a></li>
                     <li><a target="_blank" href="https://www.linkedin.com/company/vraj-farsan/"><i
                                 class="fa fa-linkedin"></i></a></li>
                 </ul><!-- .social-links end -->
             </div><!-- .col-md-6 end -->
         </div>
         <div class="col-md-12">
             <p>© Vraj Farsan. All rights reserved.</p>
         </div>
     </div>
 ...
 <script src="https://kit.fontawesome.com/54438c7cc0.js" crossorigin="anonymous"></script>
